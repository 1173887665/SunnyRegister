...
- HTTP/TLS protocol-first registration without loading page assets; currently available for Register ChatGPT Only, with challenge-triggered fallback limited to a Camoufox headless browser while the existing background and visible browser modes remain unchanged
