          ...
          <div className="card-body">
            ...
            <div className="setting-row">
              ...
              <div className="setting-control">
                ...
                >
                  <option value="mixed">通用住宅代理池（默认）</option>
                  <option value="api">API 住宅代理池优先</option>
                  <option value="clash">Clash 本地代理优先</option>
                  <option value="singbox">Clash / sing-box 节点优先</option>
