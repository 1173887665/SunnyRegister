        ...
        <div className="card-body">
          ...
          <div className="setting-row">
            ...
            <div className="setting-control">
              ...
              <span className="setting-hint">imap:/mailcom:&lt;标签&gt;（留空自动选择）</span>
            </div>
          </div>
          <div className="setting-row">
          ...
          <div className="setting-row">
            ...
            <div className="setting-control">
              <select
                ...
                style={{ width: 240 }}
              >
                <option value="">自动选择（住宅池 / Clash）</option>
                <option value="__clash__">Clash 本地代理</option>
                <option value="__api_pool__">API 住宅代理池</option>
                <option value="__mixed_pool__">通用住宅代理池</option>
              </select>
              <span className="setting-hint">按类别选择，任务启动时轮换实际 IP</span>
            </div>
          </div>
