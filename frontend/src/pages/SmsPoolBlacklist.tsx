      ...
      <Card className="overflow-hidden p-3">
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <ConfirmBubble message={t('smsPool.confirmClearAll')} onConfirm={clearAll} disabled={loading || items.length === 0}>
              <Button
                variant="outline"
                size="sm"
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-right">
                      <ConfirmBubble message={t('smsPool.confirmRestore')} detail={item.phone_e164} onConfirm={() => restore(item.phone_e164)}>
                        <Button
                          variant="outline"
                          size="sm"
                        >
