...
function protocolStageLabel(value: unknown) {
  const key = String(value || "").trim();
  return ({ queued: "排队", register_started: "注册初始化", otp_wait: "等待 OTP", otp_verified: "OTP 已校验", profile_submitted: "资料已提交", pin_set: "PIN 已设置", login: "账号登录", device_bound: "设备已绑定", session_ready: "会话已刷新", qr_submitted: "二维码已提交", payment_otp: "支付 OTP", confirmation: "支付确认", completed: "已完成", failed: "失败", cancelled: "已取消" } as Record<string, string>)[key] || key;
}
